...
class Chapter {
   ...
   */
  #[ORM\OneToOne(targetEntity: 'Drupal\musica\API\Spotify\Entity\Audiobook')]
  ...
  /**
   * @var string[] A list of the countries in which the chapter can be played, identified by their \[ISO 3166-1 alpha-2\](http://en.wikipedia.org/wiki/ISO\_3166-1\_alpha-2) code.
   */
  ...
  /**
   * A description of the chapter. HTML tags are stripped away from this field, use `html\_description` field in case HTML tags are needed.
   */
  ...
  /**
   * @var array the cover art for the chapter in various sizes, widest first
   */
  #[ORM\Column(type: 'json')]
  #[ApiProperty]
  #[Assert\NotNull]
  ...
  /**
   * @var string[] A list of the languages used in the chapter, identified by their \[ISO 639-1\](https://en.wikipedia.org/wiki/ISO\_639) code.
   */
  #[ORM\Column(type: 'json')]
  #[ApiProperty]
  #[Assert\NotNull]
